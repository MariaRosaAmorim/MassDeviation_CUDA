...
int main()
{
    ...
    // Weights
    double W[Q] = {16. / 36., 4. / 36., 4. / 36., 4. / 36., 4. / 36., 1. / 36., 1. / 36., 1. / 36., 1. / 36.};
    // Speed of sound
    double as = sqrt(3);
    double cs = 1. / as;
    int h = 1;
    ...
    size_t bytes_needed = array_size * sizeof(double);
    double *erro_arr = (double *)malloc(bytes_needed);
    double *massa_h_arr = (double *)malloc(bytes_needed);
    ...
    file_simulation_report = fopen("cpu_report.txt", "w");
